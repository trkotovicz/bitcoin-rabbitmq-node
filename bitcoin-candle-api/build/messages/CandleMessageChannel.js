...
var CandleMessageChannel = /** @class */ (function () {
    function CandleMessageChannel(server) {
        ...
        this._io.on("connection", function () { return (0, console_1.log)("Web socket connection created"); });
    }
    CandleMessageChannel.prototype._createMessageChannel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connection, _a, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_1 = _b.sent();
                        (0, console_1.log)("Connection to RabbitMQ failed");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this._channel.consume(QUEUE, function (msg) { return __awaiter(_this, void 0, void 0, function () {
                            var candleObj, candle;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        candleObj = JSON.parse(msg.content.toString());
                                        (0, console_1.log)("Message received");
                                        (0, console_1.log)(candleObj);
                                        this._channel.ack(msg);
                                        candle = candleObj;
                                        return [4 /*yield*/, this._candleCtrl.save(candle)];
                                    case 1:
                                        _a.sent();
                                        (0, console_1.log)("Candle saved to database");
                                        this._io.emit(process.env.SOCKET_EVENT_NAME, candle);
                                        (0, console_1.log)("New candle emited by web socket");
                                        return [2 /*return*/];
                                }
                            });
                        }); });
                        (0, console_1.log)("Candle consumer started");
                        return [2 /*return*/];
                }
            });
        });
