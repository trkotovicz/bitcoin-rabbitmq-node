...
var AMQP_SERVER = process.env.AMQP_SERVER;
...
var createMessageChannel = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, (0, amqplib_1.connect)(AMQP_SERVER)];
            case 1:
                connection = _a.sent();
            ...
            case 3:
                _a.sent();
                (0, console_1.log)('Connected to RabbitMQ');
                return [2 /*return*/, channel];
            case 4:
                error_1 = _a.sent();
                (0, console_1.log)('Error while trying to connect to RabbitMQ');
