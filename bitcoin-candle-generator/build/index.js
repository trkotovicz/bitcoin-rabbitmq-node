...
var API = process.env.PRICES_API;
...
var readMarketPrice = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get(String(API))];
            case 1:
                result = _a.sent();
                data = result.data;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                (0, console_1.log)('-----------------------------');
                (0, console_1.log)('Generating new candles');
                i = 0;
                _a.label = 3;
            case 3:
            ...
            case 4:
                ...
                (0, console_1.log)("Market price #".concat(i + 1, " of ").concat(loopTimes));
            ...
            case 7:
                ...
                (0, console_1.log)('Candle enqueue');
                return [3 /*break*/, 2];
